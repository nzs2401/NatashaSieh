...
// CHANGE THIS based on ESC 1500 spot!!!
int initialSpeed = 1460;  // initial ZERO speed in PWM


// Variables to manage the speed changes
int speedChange = 10;   // PWN equal to 2% change in speed
...
// Variables to calculate max CW or CCW
int maxCCW = (max_CCW_Speed - initialSpeed) / speedChange;
int maxCW = (max_CW_Speed - initialSpeed) / speedChange;


// calculate waitinterval
int waitInterval = round(5000 / maxCW); //amount in milliseconds to wait between speed changes
